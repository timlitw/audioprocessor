...
# **SEO Research Tool — Quick Commands**

Type these short commands to trigger SEO workflows. See `goals/seo_commands.md` for full details.

| Command | What it does |
|---------|--------------|
| `seo audit [url]` | Add site + run full audit + wait for completion |
| `seo narrative [audit#]` | Generate Fluence-style narrative report |
| `seo drafts [audit#]` | Generate fix drafts (titles, meta, schema, etc.) |
| `seo competitors [site#]` | Search web for competitors, present list to add |
| `seo keywords [site#]` | Show selected target keywords |
| `seo report [audit#]` | Output full audit as markdown |
| `seo compare [site#]` | Show comparison scorecard |
| `seo server` | Start the SEO tool on port 5002 |
